  ...
  subscriptionAndBilling: {
    ...
    tiers: {
      ...
      business: {
        price: '$279/month',
        processingFee: 'No platform fee',
        features: ['Everything in Pro', 'CRM included (no add-on needed)', 'Unlimited team members', 'Advanced analytics', 'Atlas SMS support', 'White-label receipts', 'Multi-location support', 'Custom Storefront Domain (coming soon)'],
        bestFor: 'High-volume artists or multi-location teams who want everything in one place.',
      },
    },
    crmAddOn: {
      overview: 'CRM is included free with Business ($279/mo) or available as a $69/month add-on for Starter and Pro. It replaces $200-400/month worth of separate tools (Mailchimp, SimpleTexting, HoneyBook, etc.) with one integrated solution built specifically for permanent jewelry artists.',
      pricing: '$69/month add-on on Starter and Pro plans, or included free with Business ($279/mo). Includes your own dedicated business phone number, two-way SMS conversations, automated aftercare sequences, broadcast messaging, client workflows, birthday automations, message templates, private party booking, and client intelligence.',
      ...
      crmTrial: 'CRM features are included free during your 30-day Pro trial. After the trial, CRM is $69/month on Starter and Pro, or included free with Business. If your trial expires without subscribing, CRM features (Messages, Broadcasts, Workflows) are locked but your data is preserved. Just activate CRM from Settings → Subscription to pick up where you left off.',
    ...
    crmRequiresBasePlan: 'CRM requires a base plan. On Starter and Pro, CRM is a $69/mo add-on. On Business ($279/mo), CRM is included free. You can\'t purchase CRM standalone after your trial expires. During your trial, CRM is included free. After the trial, choose a base plan first.',
