...
export const PJOS_PLATFORM_GUIDE = {
  ...
  subscriptionAndBilling: {
    ...
    crmAddOn: {
      overview: 'CRM is available as an add-on to any plan for $49/month. It adds automated aftercare, a dedicated business phone number with two-way SMS messaging, broadcast messaging, re-engagement campaigns, and more.',
      pricing: '$49/month add-on to any plan — includes automated aftercare sequences, your own dedicated phone number, two-way SMS conversations, broadcast messaging, client workflows, birthday automations, and message templates.',
      includes: ['Your own dedicated business phone number', 'Two-way SMS conversations with clients', 'Messages inbox for all conversations', 'Automated aftercare sequences', 'Follow-up and re-engagement campaigns', 'Broadcast messaging to client segments', 'Birthday and anniversary automations', 'Private party booking (Pro CRM)'],
