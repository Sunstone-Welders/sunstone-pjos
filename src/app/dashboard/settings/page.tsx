...
type SectionId = 'business' | 'communications' | 'pricing' | 'payments' | 'tap_to_pay' | 'billing' | 'tax' | 'waiver' | 'booking' | 'suppliers' | 'team' | 'profile';
...
function SettingsPage() {
  ...
  useEffect(() => {
    ...
    const validSections: SectionId[] = ['business', 'communications', 'pricing', 'payments', 'tap_to_pay', 'billing', 'tax', 'waiver', 'booking', 'suppliers', 'team', 'profile'];
  ...
  return (
    <div className="max-w-2xl mx-auto p-4 sm:p-6 space-y-3 pb-24">
      ...
      <AccordionSection
        ...
        title="Booking"
        summary="Manage booking types for your services"
