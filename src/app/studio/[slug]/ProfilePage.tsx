  ...
  return (
    <div className="min-h-screen bg-[var(--surface-base)]">
      <div className="max-w-[640px] mx-auto px-4 py-8 space-y-8">
        ...
        {/* ── Quick Actions ─────────────────────────────────────── */}
        {activeBookingTypesCount > 0 && (
          <section className="flex flex-wrap gap-3 justify-center">
            <Link
              href={`/studio/${slug}/book`}
              className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium bg-[var(--accent-primary)] text-[var(--text-on-accent)] rounded-xl hover:opacity-90 transition-opacity"
            >
